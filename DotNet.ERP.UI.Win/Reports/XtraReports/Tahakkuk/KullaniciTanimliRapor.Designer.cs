namespace DotNet.ERP.UI.Win.Reports.XtraReports.Tahakkuk
{
    partial class KullaniciTanimliRapor
    {
        ...
        private void InitializeComponent()
        {
            ...
            // Epos_Bilgileri
            // 
            this.Epos_Bilgileri.DataSource = typeof(DotNet.ERP.Model.Dto.EposBilgileriR);
            this.Epos_Bilgileri.Name = "Epos_Bilgileri";
            // 
            // Geri_Odeme_Bilgileri
            // 
            this.Geri_Odeme_Bilgileri.DataSource = typeof(DotNet.ERP.Model.Dto.GeriOdemeBilgileriR);
            this.Geri_Odeme_Bilgileri.Name = "Geri_Odeme_Bilgileri";
            // 
            // Hizmet_Bilgileri
            // 
            this.Hizmet_Bilgileri.DataSource = typeof(DotNet.ERP.Model.Dto.HizmetBilgileriR);
            this.Hizmet_Bilgileri.Name = "Hizmet_Bilgileri";
            // 
            // Iletisim_Bilgileri
            // 
            this.Iletisim_Bilgileri.DataSource = typeof(DotNet.ERP.Model.Dto.IletisimBilgileriR);
            this.Iletisim_Bilgileri.Name = "Iletisim_Bilgileri";
            // 
            // Indirim_Bilgileri
            // 
            this.Indirim_Bilgileri.DataSource = typeof(DotNet.ERP.Model.Dto.IndirimBilgileriR);
            this.Indirim_Bilgileri.Name = "Indirim_Bilgileri";
            // 
            // Odeme_Bilgileri
            // 
            this.Odeme_Bilgileri.DataSource = typeof(DotNet.ERP.Model.Dto.OdemeBilgileriR);
            this.Odeme_Bilgileri.Name = "Odeme_Bilgileri";
            // 
            // Ogrenci_Bilgileri
            // 
            this.Ogrenci_Bilgileri.DataSource = typeof(DotNet.ERP.Model.Dto.OgrenciR);
