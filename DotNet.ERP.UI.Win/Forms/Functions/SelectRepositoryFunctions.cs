        ...
        private static void SecimYap()
        {
            switch (_buttonEdit.Name)
            {
                ...
                case "repositoryKurum":
                    {
                        var id = _tablo.GetRowCellId(_idColumn);
                        var entity = (KurumlarL)ShowListForms<KontenjanForms.KurumlarForms.KurumlarListForm>.ShowDialogListForm(KartTuru.Kurumlar, id);
                        if (entity == null) return;
                        _tablo.SetFocusedRowCellValue(_idColumn, entity.Id);
                ...
                case "repositoryPozisyon":
                    {
                        ...
                        var id = _tablo.GetRowCellId(_idColumn);
                        var entity = (Model.Dto.PozisyonL)ShowListForms<PozisyonListForm>.ShowDialogListForm(KartTuru.Pozisyon, id);
                        if (entity == null) return;
                        _tablo.SetFocusedRowCellValue(_idColumn, entity.Id);
                        _tablo.SetFocusedRowCellValue(_nameColumn, entity.Ad);
                        _navigator.Buttons.DoClick(_navigator.Buttons.EndEdit);
                ...
                case "repositoryKisi":
                    {
                        var id = _tablo.GetRowCellId(_idColumn);
                        var entity = (Model.Dto.KisiDto.KisiL)ShowListForms<KisiListForm>.ShowDialogListForm(KartTuru.Kisi, id);
                        if (entity == null) return;
                ...
                case "repositoryCariler":
                    {
                        ...
                        {
                            case KayitTuru.Cari:
                                entity = ShowListForms<CariForms.CarilerForms.CariListForm>.ShowDialogListForm(KartTuru.Cari, seciliGelecekId: null);
                                if (entity == null) return;
                            ...
                            case KayitTuru.CariSube:
                                var parentCari = ShowListForms<CariForms.CarilerForms.CariListForm>.ShowDialogListForm(KartTuru.Cari, seciliGelecekId: null) as CariL;
                                if (parentCari == null) return;

                                var subeEntity = ShowListForms<CariSubeListForm>.ShowDialogListForm(
                                    KartTuru.CariSube,
