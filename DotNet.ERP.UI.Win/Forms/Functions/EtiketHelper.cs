...
namespace DotNet.ERP.UI.Win.Forms.Functions
{
    ...
    {
        private List<Model.Dto.EtiketL> _tumEtiketler;
        ...
        public void BaglantilariGuncelle(KayitTuru kayitTuru, long kayitId, IEnumerable<long> seciliEtiketIdler)
        {
            ...
            {
                db.EtiketKayitTuruBaglanti.Add(new Model.Entities.EtiketKayitTuruBaglanti
                {
                    EtiketId = etiketId,
                    KayitTuru = kayitTuru,
                    KayitId = kayitId
    ...
    _tumEtiketler?.FirstOrDefault(x => x.Id == id) is Model.Dto.EtiketL e
        ...
        public Color? GetEtiketForeColor(long id) =>
            _tumEtiketler?.FirstOrDefault(x => x.Id == id) is Model.Dto.EtiketL e
                ...
                : null;
        public Model.Dto.EtiketL GetEtiket(long id)
        {
