...
namespace DotNet.ERP.UI.Win.Forms.PersonelForms
{
    public partial class AdreslerEditForm : BaseEditForm
    {
        ...
        public AdreslerEditForm(long personelId)
        {
            InitializeComponent();
        ...
        private void OrtakKurulum()
        {
            ...
            // 🧾 FORM BAŞLIĞI
            var adSoyad = $"{_personelAdi} {_personelSoyadi}".Trim();
        ...
        public override void Yukle()
        {
            ...
            txtKod.Text = ((AdreslerBll)Bll).YeniKodVer(x => x.PersonelId == _personelId);
            txtBaslik.Focus();
        }
        ...
        protected override void GuncelNesneOlustur()
        {
            ...
            CurrentEntity = new Adresler
            {
                ...
                Durum = tglDurum.IsOn,
                PersonelId = BaseIslemTuru == IslemTuru.EntityInsert ? _personelId : ((AdreslerS)OldEntity).PersonelId,
                AnaKayitId = BaseIslemTuru == IslemTuru.EntityInsert ? _personelId : ((AdreslerS)OldEntity).PersonelId,
                KayitId = BaseIslemTuru == IslemTuru.EntityInsert ? _personelId : ((AdreslerS)OldEntity).PersonelId,
        ...
        {
            return ((AdreslerBll)Bll).Insert(CurrentEntity, x => x.Kod == CurrentEntity.Kod && x.KayitId == _personelId);
        }
        protected override bool EntityUpdate()
        {
            return ((AdreslerBll)Bll).Update(OldEntity, CurrentEntity, x => x.Kod == CurrentEntity.Kod && x.PersonelId == _personelId);
        }
        protected override void SecimYap(object sender)
        {
            if (sender is MyButtonEdit mbe && mbe.IsClearButtonClick) return;
