...
using DotNet.ERP.UI.Win.UserControls.UserControl.TahakkukEditFormTable;
...
namespace DotNet.ERP.UI.Win.Forms.TahakkukForms
{
    public partial class TahakkukEditForm : BaseEditForm
    {
        ...
        {
            OldEntity = BaseIslemTuru == IslemTuru.EntityInsert ? new TahakkukS() : ((TahakkukBll) Bll).Single(Functions.FilterFunctions.Filter<Tahakkuk>(Id));
