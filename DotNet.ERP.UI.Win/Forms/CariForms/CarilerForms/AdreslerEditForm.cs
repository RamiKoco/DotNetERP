...
namespace DotNet.ERP.UI.Win.Forms.CariForms.CarilerForms
{
    public partial class AdreslerEditForm : BaseEditForm
    {
        ...
        public AdreslerEditForm(long cariId)
        {
            InitializeComponent();
        ...
        private void OrtakKurulum()
        {
            ...
            // 🧾 FORM BAŞLIĞI
            if (!string.IsNullOrWhiteSpace(_cariAdi))
            {
                Text = Text + $" - ( {_cariAdi} )";
            }
        }
        public override void Yukle()
        {
            ...
            txtKod.Text = ((AdreslerBll)Bll).YeniKodVer(x => x.CariId == _cariId);
            txtBaslik.Focus();
        }    
        ...
        protected override void GuncelNesneOlustur()
        {
            ...
            CurrentEntity = new Adresler
            {
                ...
                Durum = tglDurum.IsOn,
                CariId = BaseIslemTuru == IslemTuru.EntityInsert ? _cariId : ((AdreslerS)OldEntity).CariId,
                AnaKayitId = BaseIslemTuru == IslemTuru.EntityInsert ? _cariId : ((AdreslerS)OldEntity).CariId,
                KayitId = BaseIslemTuru == IslemTuru.EntityInsert ? _cariId : ((AdreslerS)OldEntity).CariId,
        ...
        {
            return ((AdreslerBll)Bll).Insert(CurrentEntity, x => x.Kod == CurrentEntity.Kod && x.CariId == _cariId);
        }
        protected override bool EntityUpdate()
        {
            return ((AdreslerBll)Bll).Update(OldEntity, CurrentEntity, x => x.Kod == CurrentEntity.Kod && x.CariId == _cariId);
        }
