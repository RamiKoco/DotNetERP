...
namespace DotNet.ERP.UI.Win.Forms.CariForms.CarilerForms
{
    public partial class IletisimEditForm : BaseEditForm
    {
        ...
        public IletisimEditForm(long cariId)
        {
            InitializeComponent();
        ...
        public override void Yukle()
        {
            ...
            txtKod.Text = ((IletisimBll)Bll).YeniKodVer(x => x.CariId == _cariId);
            txtBaslik.Focus();
        }
        ...
        protected override void GuncelNesneOlustur()
        {
            ...
            CurrentEntity = new Iletisim
            {
                ...
                VoipMi = tglVoip.IsOn,
                Durum = tglDurum.IsOn,
                CariId = BaseIslemTuru == IslemTuru.EntityInsert ? _cariId : ((IletisimS)OldEntity).CariId,               
                KayitId = BaseIslemTuru == IslemTuru.EntityInsert ? _cariId : ((IletisimS)OldEntity).CariId,
        ...
        {
            return ((IletisimBll)Bll).Insert(CurrentEntity, x => x.Kod == CurrentEntity.Kod && x.CariId == _cariId);
        }
        protected override bool EntityUpdate()
        {
            return ((IletisimBll)Bll).Update(OldEntity, CurrentEntity, x => x.Kod == CurrentEntity.Kod && x.CariId == _cariId);
        }
