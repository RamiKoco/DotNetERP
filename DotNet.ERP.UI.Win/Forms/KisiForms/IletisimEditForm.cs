    ...
    public partial class IletisimEditForm : BaseEditForm
    {
        ...
        public IletisimEditForm(params object[] prm)
        {
            ...
            if (prm?.Length > 1 && prm[1] != null)
                _kayitTuru = (KayitTuru)prm[1];
            else
                _kayitTuru = KayitTuru.Kisi; // default

            OrtakKurulum();
        }

        public IletisimEditForm(long kisiId, KayitTuru kayitTuru = KayitTuru.Kisi)
        {
            InitializeComponent();
        ...
        private void OrtakKurulum()
        {
            ...
            // 📌 ENUM DOLDURMALARI (ESKİ CONSTRUCTOR'DAN!)
            txtKayitTuru.Properties.Items.AddRange(
                EnumFunctions.GetEnumDescriptionList<KayitTuru>());
            ...
            txtKayitTuru.EditValue = _kayitTuru.ToName();   // 🔥 sadece burada
            txtKayitTuru.Enabled = false;                   // 🔒 güncellenemesin
        ...
        protected override void NesneyiKontrollereBagla()
        {
            ...
            if (BaseIslemTuru == IslemTuru.EntityInsert)
            {
                txtKayitTuru.EditValue = _kayitTuru.ToName(); // zaten kilitli
                txtKayitHesabi.Id = _kisiId;
            }
            txtKayitHesabi.Text = entity.KayitHesabiAdi;
