...
using DotNet.ERP.UI.Win.Forms.BelgeTuruForms;
...
using DotNet.ERP.UI.Win.Forms.FaturaForms;
using DotNet.ERP.UI.Win.Forms.GorevForms;
using DotNet.ERP.UI.Win.Forms.HizmetForms;
using DotNet.ERP.UI.Win.Forms.HizmetTuruForms;
//using DotNet.ERP.UI.Win.Forms.IletisimForms;
using DotNet.ERP.UI.Win.Forms.IlForms;
using DotNet.ERP.UI.Win.Forms.IndirimForms;
using DotNet.ERP.UI.Win.Forms.IndirimTuruForms;
using DotNet.ERP.UI.Win.Forms.IptalNedeniForms;
...
using DotNet.ERP.UI.Win.Forms.OgrenciForms;
...
using DotNet.ERP.UI.Win.Forms.ServisForms;
...
using DotNet.ERP.UI.Win.Forms.YakinlikForms;
using DotNet.ERP.UI.Win.Reports.FormReports;
...
namespace DotNet.ERP.UI.Win.GenelForms
{
    public partial class AnaForm : DevExpress.XtraBars.Ribbon.RibbonForm
    {
        ...
        private void GallleryItem_GalleryItemClick(object sender, DevExpress.XtraBars.Ribbon.GalleryItemClickEventArgs e)
        {
            ...
            Forms.Functions.GeneralFunctions.AppSettingsWrite(key, e.Item.Caption);
        }
        ...
        private void Butonlar_ItemClick(object sender, ItemClickEventArgs e)
        {
            ...
            if (e.Item==btnOkulKartlari)
                ...
                ShowListForms<Forms.AdreslerForms.AdresListForm>.ShowListForm(KartTuru.AdresBilgileri);
                ...
                ShowListForms<Forms.KontenjanForms.KurumlarForms.KurumlarListForm>.ShowListForm(KartTuru.Kurumlar);
            else if (e.Item == btnCarilerKartlari)
                ShowListForms<Forms.CariForms.CarilerForms.CariListForm>.ShowListForm(KartTuru.Cari);
                ...
                ShowListForms<Forms.IletisimlerForms.IletisimListForm>.ShowListForm(KartTuru.Iletisim);
