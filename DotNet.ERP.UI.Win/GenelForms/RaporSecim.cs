...
using DotNet.ERP.UI.Win.Reports.XtraReports.Fatura;
using DotNet.ERP.UI.Win.Reports.XtraReports.Makbuz;
using DotNet.ERP.UI.Win.Reports.XtraReports.Tahakkuk;
...
namespace DotNet.ERP.UI.Win.GenelForms
{
    public partial class RaporSecim : BaseListForm
    {
        ...
        public RaporSecim(params object[] prm)
        {
            ...
            txtYaziciAdi.Properties.Items.AddRange(Forms.Functions.GeneralFunctions.YazicilariListele());
            txtYaziciAdi.EditValue = Forms.Functions.GeneralFunctions.DefaultYazici();
