namespace DotNet.ERP.UI.Win.GenelForms
{
    partial class SubeDonemSecimiEditForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.donemGrid = new DotNet.ERP.UI.Win.UserControls.Grid.MyGridControl();
            this.donemTablo = new DotNet.ERP.UI.Win.UserControls.Grid.MyGridView();
            this.colDonemId = new DotNet.ERP.UI.Win.UserControls.Grid.MyGridColumn();
            this.colDonemAdi = new DotNet.ERP.UI.Win.UserControls.Grid.MyGridColumn();
            this.donemNavigator = new DotNet.ERP.UI.Win.UserControls.Navigators.SmallNavigator();
            this.subeNavigator = new DotNet.ERP.UI.Win.UserControls.Navigators.SmallNavigator();
            this.subeGrid = new DotNet.ERP.UI.Win.UserControls.Grid.MyGridControl();
            this.subeTablo = new DotNet.ERP.UI.Win.UserControls.Grid.MyGridView();
            this.colSubeId = new DotNet.ERP.UI.Win.UserControls.Grid.MyGridColumn();
            this.colSubeAdi = new DotNet.ERP.UI.Win.UserControls.Grid.MyGridColumn();
