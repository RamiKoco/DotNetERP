...
namespace DotNet.ERP.UI.Win.GenelForms
{
    public partial class GirisForm : XtraForm
    {
        ...
        private void Yukle()
        {
            ...
            if (!Forms.Functions.GeneralFunctions.BaglantiKontrolu(server, kullaniciAdi, sifre, yetkilendirmeTuru, true))
            {
            ...
            Forms.Functions.GeneralFunctions.CreateConnectionString("DotNet_ERP_Yonetim", server,
            ...
            using (var bll = new KurumBll())
            {
                ...
                txtKurum.Properties.DisplayMember = "Ad";
        ...
        private void CreateConnection()
        {
            ...
            if (!Forms.Functions.GeneralFunctions.BaglantiKontrolu(server, kullaniciAdi, sifre, yetkilendirmeTuru)) return;
            Forms.Functions.GeneralFunctions.CreateConnectionString(kod, server,
                kullaniciAdi, sifre, yetkilendirmeTuru);
