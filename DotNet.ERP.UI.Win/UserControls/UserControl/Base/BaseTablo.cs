...
namespace DotNet.ERP.UI.Win.UserControls.UserControl.Base
{
    public partial class BaseTablo : XtraUserControl
    {
        ...
        protected virtual void DosyaAc() { }
        protected virtual void DosyaIndir() { }
        protected virtual void DosyaDuzelt() { }
        ...
        private void Button_ItemClick(object sender, ItemClickEventArgs e)
        {
            ...
            if (e.Item == btnHareketEkle)
                ...
                TumunuSec();
            else if (e.Item == btnAc)
                DosyaAc();
            else if (e.Item == btnIndir)
                DosyaIndir();
        ...
        protected virtual void KaydetSonrasi() { }
        public void DegisiklikleriTemizle()
        {
            var list = Tablo.DataController.ListSource as IEnumerable<IBaseHareketEntity>;
            if (list == null) return;
