...
namespace DotNet.ERP.UI.Win.UserControls.UserControl.PersonelEditFormTable
{
    public partial class IletisimBilgileriTable : BaseTablo
    {
        ...
        protected internal override void Listele()
        {
            ...
            //    .List(x => x.PersonelId == OwnerForm.Id && x.IletisimTuru == iletisimTuruEnum)
            //    .ToBindingList<IletisimL>();

            var list = ((IletisimBll)Bll)
            .List(x =>
                x.PersonelId == OwnerForm.Id &&
        ...
        protected override void HareketEkle()
        {
            var result = ShowEditForms<IletisimEditForm>.ShowDialogEditForm(
                KartTuru.Iletisim,
                0,                  // 🔴 yeni kayıt
                OwnerForm.Id        // 🔴 personelId
                                    // personelAdi / personelSoyadi yoksa göndermiyoruz
            );
            Listele();
        }
