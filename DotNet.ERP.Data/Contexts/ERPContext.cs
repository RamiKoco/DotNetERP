using DotNet.ERP.Data.ERPMigration;
...
{
    public class ERPContext : BaseDbContext<ERPContext, ERPConfiguration>
    {
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Cari>().HasMany(x => x.CariSube).WithRequired().WillCascadeOnDelete(true);
        ...
        public DbSet<CariSube> CariSube { get; set; }
        public DbSet<CariTuru> CariTuru { get; set; }
        public DbSet<Model.Entities.CariEntity.CariGruplari.CariGrubu> CariGrubu { get; set; }
        ...
        public DbSet<Ekler> Ekler { get; set; }
        public DbSet<EklerDepolamaAyarlari> EklerDepolamaAyarlari { get; set; }
    }
}