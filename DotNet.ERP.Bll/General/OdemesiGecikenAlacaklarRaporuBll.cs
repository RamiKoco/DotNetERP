        ...
        public IEnumerable<OdemesiGecikenAlacaklarRaporuL> List(Expression<Func<OdemeBilgileri, bool>> filter, IEnumerable<BelgeDurumu> belgeDurumlari)
        {
            return List(filter, x => new
            {
                ...
                Toplamlar = x.MakbuzHareketleri.GroupBy(y => y.OdemeBilgileriId).DefaultIfEmpty().Select(y => new
                {
                    ...
                    SonIslemYeri = y.OrderByDescending(z => z.Id).Select(z => z.Makbuz.AvukatHesapId != null ? z.Makbuz.AvukatHesap.AdiSoyadi : z.Makbuz.BankaHesapId != null ? z.Makbuz.BankaHesap.HesapAdi : z.Makbuz.CariHesapId != null ? z.Makbuz.CariHesap.Ad : z.Makbuz.KasaHesapId != null ? z.Makbuz.KasaHesap.KasaAdi : z.Makbuz.SubeHesap.SubeAdi).FirstOrDefault()
                }).FirstOrDefault(),
            ...
            }).Select(x => new OdemesiGecikenAlacaklarRaporuL
            {
                ...
                VeliAdi = x.VeliBilgileri.Iletisim.Kisi.Ad,
                VeliSoyadi = x.VeliBilgileri.Iletisim.Kisi.Soyad,
