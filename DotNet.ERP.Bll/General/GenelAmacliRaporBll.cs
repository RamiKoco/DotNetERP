    ...
    public class GenelAmacliRaporBll : BaseBll<Tahakkuk,ERPContext>
    {
        public IEnumerable<GenelAmacliRaporL> List(Expression<Func<Tahakkuk, bool>> filter)
        {
            ...
            }).Select(x => new GenelAmacliRaporL
            {
                ...
                Kadin = x.Tahakkuk.Ogrenci.Cinsiyet == Cinsiyet.Kadin ? 1 : 0,
                ...
                //VeliTcKimlikNo = x.VeliBilgileri.Iletisim.Personel.KimlikNo,
                //VeliAdi = x.VeliBilgileri.Iletisim.Personel.Ad,
                //VeliSoyadi = x.VeliBilgileri.Iletisim.Personel.Soyad,
                //VeliBabaAdi = x.VeliBilgileri.Iletisim.Personel.BabaAdi,
                //VeliAnaAdi = x.VeliBilgileri.Iletisim.Personel.AnaAdi,
                //VeliDogumYeri = x.VeliBilgileri.Iletisim.DogumYeri,
                //VeliDogumTarihi = x.VeliBilgileri.Iletisim.Personel.DogumTarihi,
                //VeliKanGrubu = x.VeliBilgileri.Iletisim.Personel.KanGrubu,
